#!/usr/bin/python3
""" The N queens puzzle - the  challenge of placing N non attacking queens
on NxN chessboard
this program is solving the N queens problem """

from sys import argv


def is_NQueen(cell: list) -> bool:
    """ it is false if not N Queen and True if N Queen """
...
def solve_NQueens(dimension: int, row: int, cell: list, output: list):
    """ returning the result of the N Queens recursively """
    if row == dimension:
        print(output)
    else:
